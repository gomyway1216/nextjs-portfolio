...
Except. **The person writing this article (a 2-dan amateur) actually played the production hard difficulty (2 seconds) — and won.** Not by a hair, either, and with the report: "still way too weak. **It plays nonsense move after nonsense move.**" Dropping a pawn somewhere irrelevant to the mate, walking its own king into the danger zone — moves that any human sees instantly as "what is this," chosen after a full 2 seconds of thought.
