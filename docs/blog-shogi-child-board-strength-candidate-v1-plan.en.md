...
## Fix the student/runtime contract before tune
...
Only an admitted student may enroll in the existing formal-v2 contract:
...
Only a formal stronger-gate pass binds the exact student/runtime into the existing 81Dojo protocol:
...
Phase 1 has not started. Checkpoints are 0/2, tune is unopened, the student protocol is unmerged, sealed labels are zero, formal play is 0/768, external play is 0/200, and live changes are zero. No static gate independently authorizes a live change.
