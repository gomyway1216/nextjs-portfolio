...
4. Take the [STOP-only recovery-operator foundation](./blog-shogi-floodgate-v7-production-recovery-operator-foundation.en.md), which has only a fixed origin and zero-argument source authorization and accesses no production state, through final-head CI, independent review, and a regular merge. Do not treat this placeholder as an inspector or reconciliation authority.
