...
> **v2 update (current boundary):** Attempt 5 in the body is historical v1 evidence, not current v2 evidence. The current accepted evidence is Attempt 6 (source commit `017692c7a076babbd40e7be0b14ea27d9988fa6c`, harness SHA-256 `23578cbf11deafb49cd288f38d9f3ec081e76d0f41a5b2948b3ccf08fabfb9a2`): wall time `435.60 s`, valid stream `429,245,287 bytes`, stream SHA-256 `8039ec02f3421d934d0a9f1d10b47a97f273e397ad414e64db50bded13c498ac`, maximum RSS `483,491,840 bytes`, `0` new temporary roots after exit, and a clean worktree both before and after the run. This is evidence only for a holdout-free synthetic 24,000-parent scanner load; it makes no claim about real Floodgate labels, a production coordinator / live environment, training, weights, matches, or playing strength. The body below and its Attempt 5 values remain unchanged as a historical record.
