...
The corrected preregistration, deterministic selector, legal-count enricher, teacher plan/receipt schemas, and unit tests are being implemented now. Formal teacher computation has not started. Selection and depth-18 work begin only after the PR is regularly merged and the merged source and plan bytes/SHA are frozen. The live baseline is pinned to `public/shogi-nnue-weights.bin`, 1,185,988 bytes, SHA-256 `e4e738f99fbd8685bcfe2700e4df364af6274e75b44b298432fc313b9a3e28dc`; the public flag remains unchanged.
