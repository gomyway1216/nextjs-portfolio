...
We tested only the final hypothesis—that an overly high policy temperature had flattened top-1—with three preregistered temperature-50, one-epoch diagnostics. Baseline chose the teacher's top move on 66 of 643 parents; passing required at least 68. The arms used policy weight 0.0625/rank 0, policy 0.125/rank 0, and policy 0.0625/rank 0.25. All exited successfully, but **every arm scored 65/643, 0.1555 percentage points below baseline**. Pair gains were +0.2456, +0.2383, and +0.2338 points; preservation MAE improved by 33.7, 34.4, and 33.5cp; loss ratios were 0.9291, 0.9279, and 0.9297; and runtimes were 64.8028, 64.2210, and 65.3695 seconds. The temperature hypothesis failed: better value and average ordering still did not improve the actual argmax. We did not start any three-epoch continuation, export, quantized parity, or match. This permanently closes the browser-confusion sibling lane, and production weights remain unchanged.
