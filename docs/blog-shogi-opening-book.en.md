...
The change that crossed both the 56-game screen and the independent 96-game confirmation was neither a larger model nor more data. **It retained half of production's practical ordering and averaged away an over-large training update.** The 768-game formal test and external calibration still decide deployment; a failure there still means no promotion.
