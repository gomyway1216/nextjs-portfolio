...
| selection audit                                   | **Confirmed failure receipt**        | 27,692 bytes / `bd62ff06…798634`; seven-model export/report reproduction exact; no success candidate receipt emitted                                                 |
