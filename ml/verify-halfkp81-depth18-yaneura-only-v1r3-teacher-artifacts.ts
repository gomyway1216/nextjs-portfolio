...
import { HALFKP81_DEPTH18_YANEURA_ONLY_V1R3_DEFAULT_DIRECTORY } from "./halfkp81-depth18-teacher-runner";
...
async function main(): Promise<void> {
  ...
  const result = await verifyAndPublishHalfkp81Depth18TeacherArtifacts({
    artifactRoot: HALFKP81_DEPTH18_YANEURA_ONLY_V1R3_DEFAULT_DIRECTORY,
    planPath: path.join(
      HALFKP81_DEPTH18_YANEURA_ONLY_V1R3_DEFAULT_DIRECTORY,
      "teacher-plan.json",
    ),
  });
