...
const nextConfig: NextConfig = {
  ...
  async headers() {
    return [
      ...
      // The Rammy roguelike is a Godot HTML5 build served from
      // public/games/rammy/. index.wasm is the Godot engine template - the same
