/**
 * FROZEN BASELINE copy of src/components/game/Daifugo/DaifugoAI.ts, used only
 * by scripts/daifugo-ai-match.ts to A/B candidate changes against the previous
 * production behavior (same convention as ShogiAIImprovedV20Base for Shogi).
 * Do NOT edit this file when improving the production AI — that is the point.
 *
...
import type { DaifugoNetworkState } from '../src/components/game/Daifugo/multiplayerTypes';
import type { Card } from '../src/components/game/Daifugo/types';
import { isJoker, TWO_RANK } from '../src/components/game/Daifugo/types';
import { applyAction, getPlayShape, sortHand } from '../src/components/game/Daifugo/gameLogic';
import type { DaifugoPlayShape } from '../src/components/game/Daifugo/gameLogic';
