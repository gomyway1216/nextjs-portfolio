/**
 * FROZEN BASELINE — the pre-fair-play Shichinarabe AI, kept verbatim (imports
 * re-pointed at src/) so scripts/shichinarabe-ai-match.ts can A/B the current
 * production AI against the old hidden-information version. This copy still
 * reads opponents' concealed hands in opponentGiftCount; do NOT ship it.
 */
...
import type { ShichinarabeNetworkState } from '../src/components/game/Shichinarabe/multiplayerTypes';
import type { Card, CardSuit } from '../src/components/game/Shichinarabe/types';
import { MAX_RANK, MIN_RANK, SEVEN_RANK } from '../src/components/game/Shichinarabe/types';
import { getPlayableCardsForPlayer } from '../src/components/game/Shichinarabe/gameLogic';
