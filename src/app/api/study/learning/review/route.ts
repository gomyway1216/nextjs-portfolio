...
export const GET = withActivityLog('next_api.study.learning.review.GET', async (request: NextRequest) => {
  try {
...
export const POST = withActivityLog('next_api.study.learning.review.POST', async (request: NextRequest) => {
  try {
