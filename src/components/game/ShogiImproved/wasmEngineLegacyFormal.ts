/**
 * Historical formal-A/B client for the byte-pinned legacy WASM engine.
 *
 * This module intentionally retains the pre-HalfKP64-RKI16 runtime contract
 * used by sealed historical formal A/B evidence. Browser play imports
 * wasmEngine.ts instead.
 *
