...
const en: HoldemStrings = {
  ...
  info: {
    ...
    bullets: [
      ...
      'The current version uses one balanced baseline for every opponent; it does not yet learn per-player tendencies.',
    ],
...
const ja: HoldemStrings = {
  ...
  info: {
    ...
    bullets: [
      ...
      '現バージョンは全プレイヤーに共通のバランス戦略を使い、相手ごとの癖はまだ学習しません。',
    ],
