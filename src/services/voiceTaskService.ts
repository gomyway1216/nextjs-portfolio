...
export const getAllTaskLists = async (userId: string): Promise<any[]> => {
  try {
...
export const getIncompleteTasks = async (userId: string, listId: string): Promise<any[]> => {
  try {
...
export const getCompletedTasks = async (userId: string, listId: string): Promise<any[]> => {
  try {
...
export const getStarredTasks = async (userId: string): Promise<any[]> => {
  try {
...
export const createTask = async (userId: string, taskData: any): Promise<any> => {
  try {
...
export const createTaskList = async (userId: string, listName: string): Promise<any> => {
  try {
    const response = await fetch(`${API_BASE_URL}/users/${userId}/task-lists`, {
      method: 'POST',
      headers: {
...
export const createSubTask = async (userId: string, taskId: string, subtaskData: any): Promise<any> => {
  try {
