...
describe("HalfKP81 v1r10 exact-set import into v1r11", () => {
  ...
  it("pins the durable r12 set and rejects its fingerprint for the r13 target", async () => {
    const invalid = snapshot("invalid-r12.json");
    expect(() =>
      validateHalfkp81Depth18V1R11MinimalR12ImportableSet({
        plan: invalid,
        selection: invalid,
    ...
    ).toThrow("minimal-r12 source plan identity differs");
    const fingerprint =
      "9dba6a5c0850dc915088e97c544c040f32ebf79336951128d9d5414d7822099c";
    await expect(
      importHalfkp81Depth18V1R11MinimalR12CompletedSetIntoR13({
        repositoryRoot: "/private/tmp/does-not-exist",
        targetWorkPath: "/private/tmp/never-created-r13/work.jsonl",
        targetHeader: Object.freeze({
          schema: "shogi-halfkp81-hard-depth18-yaneura-only-teacher-work-v1r11",
          run_fingerprint: fingerprint,
        }),
        ...
        authorityDirectory: "/private/tmp/never-created-r13/authority",
      }),
